...
import { View, Text, ImageBackground, StyleSheet, Image, TouchableOpacity, Dimensions, StatusBar, Modal } from 'react-native';
...
const NovenaPrayer = () => {
  ...
  const [selectedTab, setSelectedTab] = useState('NovenaPrayer');
